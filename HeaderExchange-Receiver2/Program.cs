...
namespace HeaderExchange_Receiver2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var connection = factory.CreateConnection())
            {
                ...
                {
                    //*** Receiverlar icerisindeki exchange veya queue deklare islemleri kontrol amaclıdır. eger boyle bir kuyruk yoksa yaratılması içindir. 
                    ...
                    channel.BasicConsume(queue: "newsheader_all_articles", autoAck: true, consumer: consumer);
                    Console.ReadLine();
                }
            }

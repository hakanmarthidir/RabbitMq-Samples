...
namespace TopicExchange_Receiver3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var connection = factory.CreateConnection())
            {
                ...
                {
                    //Exchange Deklare Edilir. Topic tipinde bir exchange duzenlendi. 
                    ...
                    channel.BasicConsume(queue: "newstopic_bbcnewsweather", autoAck: true, consumer: consumer);
                    Console.ReadLine();
                }
            }           
        }
